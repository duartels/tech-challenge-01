...
export const NewTransaction = () => {
	...
	return (
		<div className="bg-gray-background w-[321px] h-[680px] sm:w-[600px] sm:h-[450px] md:w-[690px] rounded-lg sm:p-8 flex flex-col items-center sm:items-start pt-8 bg-[url('/icons/new-transaction-top-mobile.svg'),url('/icons/new-transaction-bottom-mobile.svg')] sm:bg-[url('/icons/new-transaction-top.svg'),url('/icons/new-transaction-bottom.svg')] bg-no-repeat [background-position:top_left,bottom_right] sm:[background-position:top_right,bottom_left]">
