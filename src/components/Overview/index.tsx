import { NavOptions, OverviewProps } from '@domain';
	...
	return (
		...
		>
			<div className="flex flex-col gap-10 sm:gap-0 items-center sm:items-start sm:flex-row justify-between p-10 sm:p-8">
				...
				<div className="sm:pt-[60px] sm:pr-24">
					<div className="flex gap-6 items-center">
						...
						<FaEye size={20} className="text-white cursor-pointer" onClick={handleBalanceVisibility} />
					</div>
			...
			<div className="pb-8 sm:pb-0 sm:pl-8 flex justify-center sm:justify-start sm:relative md:hidden">
				<Image src="/icons/overview-money.svg" alt="Money illustration" width={283} height={228} className="sm:absolute sm:top-[-100px]" />
			</div>
		</div>
	);
};
